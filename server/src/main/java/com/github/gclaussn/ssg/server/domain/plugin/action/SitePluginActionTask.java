...
class SitePluginActionTask implements Runnable, SiteConsole {

  private static final Logger LOGGER = LoggerFactory.getLogger(SitePluginActionTask.class);

  protected Site site;

  protected String pluginAction;
  ...
  @Override
  public void run() {
    LOGGER.info("Task {}: {}: Started", id, pluginAction);
    ...
    try {
      ...
      site.getPluginManager().execute(pluginAction, properties);
    ...
    LOGGER.info("Task {}: {}: Finished", id, pluginAction);
    done = true;
  }
}
