...
import com.github.gclaussn.ssg.impl.file.FileWatcherFactory;
...
public interface SiteFileWatcher {
  ...
  static final String THREAD_NAME = "ssg-file-watcher";
  ...
  static SiteFileWatcher of(Site site) {
    return FileWatcherFactory.of(site).create();
  }
  ...
  static SiteFileWatcher of(Site site, SiteFileWatcherType type) {
    return FileWatcherFactory.of(site).create(type);
  }
